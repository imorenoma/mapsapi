...
In this code we can se how do we take data from  the Comunidad de Madrid Open Data, in order to send it to the front and print this data, in this case we send name of the museum and the addres
